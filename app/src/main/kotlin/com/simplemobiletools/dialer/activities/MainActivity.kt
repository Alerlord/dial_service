...
class MainActivity : SimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.CAPTURE_AUDIO_OUTPUT),1);
        Log.e("AUDIORECORD", ActivityCompat.checkSelfPermission(this, Manifest.permission.CAPTURE_AUDIO_OUTPUT).toString())
        ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.MODIFY_PHONE_STATE),1);
        Log.e("PHONESTATE", ActivityCompat.checkSelfPermission(this, Manifest.permission.MODIFY_PHONE_STATE).toString())
